...
export const Wabisabi: FC = ()=>{
    return (
        <section className="relative bg-black before:absolute before:inset-0 before:-z-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h1 className="text-white text-4xl lg:text-6xl font-bold">
                <span className="">Wabi Sabi</span> Architecture
            </h1>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              We design spaces that honor the natural world, blending wood, stone, and organic textures for a tranquil living experience.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Our designs focus on decluttered, serene environments that prioritize function without sacrificing beauty.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Imperfect Beauty</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                We craft designs that appreciate asymmetry, patina, and the passage of time, turning imperfections into soulful elements.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Using sustainable practices and materials, we ensure every project contributes to a healthier planet.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Personalized Spaces</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                We create bespoke designs tailored to your unique lifestyle and preferences, reflecting the essence of Wabi-Sabi.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Timeless Tranquility</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Our designs age gracefully, adapting to changes while maintaining their serene essence.
              </p>
            </article>
          </div>
        </div>
